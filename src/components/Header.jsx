   ...
   const [size, setsize] = useState(0)
     useEffect(() => {
      ...
      if (size < 768) {
            ...
            <div className='bg-black flex justify-center'>
                <div className='w-1/3 text-white flex items-center justify-center '>
                    <ul className='flex space-x-7 text-base  justify-center font-bold flex-wrap'>
                        ...
                        <li className='underline-offset-4  decoration-yellow-400 hover:underline  hover:text-yellow-400'><Link to="/about">Contact</Link></li>
                    </ul>
                </div>
                <div className='w-1/3 '>
                    <img className='m-auto' src="https://themewagon.github.io/burger/img/logo.png" alt="" />
                </div>
                <div className='w-1/3 flex items-center space-x-4'>
                    <img src="src\assets\icons8-instagram.svg" alt="" />
                    <img src="src\assets\icons8-twitter.svg" alt="" />
                </div>
            </div>
          )
      } else {
        ...
        <img onClick={dispfuntion} className='w-10' src="src\assets\icons8-menu.svg" alt="" />
        </div>
